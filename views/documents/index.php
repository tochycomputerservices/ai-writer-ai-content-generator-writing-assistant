        ...
        <div class="col-12 col-xl-auto d-flex">
            ...
            <div class="ml-3">
                <a href="<?= url('templates') ?>" class="btn btn-outline-primary">
                    <i class="fa fa-fw fa-moon fa-sm mr-1"></i> <?= l('templates.menu') ?>
                </a>
            </div>
        ...
        <div class="table-responsive table-custom-container">
            <table class="table table-custom">
                ...
                <tr>
                    ...
                    <th><?= l('documents.words') ?> <span data-toggle="tooltip" title="<?= l('documents.words_help') ?>"><i class="fa fa-fw fa-sm fa-info-circle text-muted"></i></span></th>
                    <th></th>
                    <th></th>
                </tr>
                </thead>
